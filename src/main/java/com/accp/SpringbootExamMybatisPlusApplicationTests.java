...
public class SpringbootExamMybatisPlusApplicationTests {
	 ...
	 * 代码生成者
	 */
	private static final String AUTHOR = "lhp";

	/**
	 * JDBC相关配置
	 */
	private static final String DRIVER = "com.mysql.cj.jdbc.Driver";
	private static final String URL = "jdbc:mysql://localhost:3306/erp?useUnicode=true&characterEncoding=utf-8&allowMutilQueries=true&serverTimezone=UTC";
